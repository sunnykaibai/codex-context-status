...
- Include the ChatGPT desktop version and `scripts/doctor-native.sh` output for native-mode reports. Include `scripts/doctor.sh` output when reporting full-bar selector or CDP startup failures.

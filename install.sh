...
install -m 644 \
  "$project_dir/launchd/io.github.sunnykaibai.codex-context-status.injector.plist" \
  "$launch_agent"
...
print "Installed Codex Context Status."
print ""
print "1. Quit ChatGPT completely."
